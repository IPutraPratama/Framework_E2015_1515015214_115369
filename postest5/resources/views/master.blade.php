    ...
    <body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown active">
                        <a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Pengaturan <span class="caret"></span>
                         ...
                         <ul class="dropdown-menu" aria-labelledby="dLabel">
                                <li><a href="{{url('penggguna')}}">penggguna</a></li>
                                <li class="divider"></li>
       ...
       <nav class="navbar navbar-default navbar-fixed-bottom">
           <footer class="container">
               ...
               created by <a href="http://twiter.com/IrfanPutraPratama">
               <span><i class="fa fa-twitter" style="color: #1da1f2"></i>@IrfanPutraPratama</span></a> <!--/   please dont delete this    -->
           </footer>
       </nav>
